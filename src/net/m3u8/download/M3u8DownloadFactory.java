...
public class M3u8DownloadFactory {
    ...
    public static class M3u8Download {
        ...
        private void deleteFiles() {
            ...
            for (File f : file.listFiles()) {
                if (f.getName().endsWith(".lsx1") || f.getName().endsWith(".lsx2")) {
                    f.delete();
                }
            }
        }
        ...
        private Thread getThread(String urls, int i) {
            return new Thread(() -> {
                ...
                File file2 = new File(dir + FILESEPARATOR + i + ".lsx1");
                if (file2.exists()) {
                    file2.delete();
                }
                ...
                while (count <= retryCount) {
                    try {
                        ...
                        File file = new File(dir + FILESEPARATOR + i + ".lsx2");
        ...
        private M3u8Download(String DOWNLOADURL) {
            ...
            requestHeaderMap.put("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36");
        }
     ...
     * @return
     */
    public static M3u8Download getUrlInfo(String url) {
        return new M3u8Download(url);
    }
